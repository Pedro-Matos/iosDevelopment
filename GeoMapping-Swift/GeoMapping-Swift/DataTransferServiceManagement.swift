//
//  DataTransferServiceManagement.swift
//  GeoMapping-Swift
//
//  Created by Pedro Ferreira de Matos on 20/05/17.
...
class DataTransferServiceManagement: NSObject {
    
    // Service type must be a unique string, at most 15 characters long
    // and can contain only ASCII lowercase letters, numbers and hyphens.
    private let DataServiceType = "example-color"
    
    private let myPeerId = MCPeerID(displayName: UIDevice.current.name)
    private let serviceAdvertiser : MCNearbyServiceAdvertiser
    private let serviceBrowser : MCNearbyServiceBrowser
    
    var delegate : DataTransferServiceManagementDelegate?
...
extension DataTransferServiceManagement : MCNearbyServiceAdvertiserDelegate {
...
extension DataTransferServiceManagement : MCNearbyServiceBrowserDelegate {
...
extension DataTransferServiceManagement : MCSessionDelegate {
